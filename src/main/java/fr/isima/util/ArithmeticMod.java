...
public class ArithmeticMod  {
   ...
   public static void matVecModM (long A[][], long s[], long v[], long m)  {
     ...
     *
     */
    public static void matVecModM_high(double A[][], double s[], double v[],
                                        double m) {
        int i;
        double x[] = new double[3]; // Necessary if v = s

        for (i = 0; i < 3; ++i) {
            x[i] = multModM(A[i][0], s[3], 0.0, m);
            x[i] = multModM(A[i][1], s[4], x[i], m);
            x[i] = multModM(A[i][2], s[5], x[i], m);
        }
        for (i = 0; i < 3; ++i) {
            v[i + 3] = x[i];
        }
     ...
     *
     */
    public static void matVecModM_low(double A[][], double s[], double v[],
                                       double m) {
        int i;
        double x[] = new double[3]; // Necessary if v = s
